...
\providecommand{\algDtables}{\StrLeft{PSO}{\ntables}}
\providecommand{\algCtables}{\StrLeft{DEPSO}{\ntables}}
\providecommand{\algBtables}{\StrLeft{DE}{\ntables}}
\providecommand{\algAtables}{\StrLeft{CMA-ES}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{CMA-E_DE_DEPSO_PSO/}
\providecommand{\algorithmA}{CMA-ES}
\providecommand{\algorithmB}{DE}
\providecommand{\algorithmC}{DEPSO}
...
\providecommand{\algDtables}{\StrLeft{DEPSO}{\ntables}}
\providecommand{\algCtables}{\StrLeft{DE}{\ntables}}
\providecommand{\algBtables}{\StrLeft{CMA-ES}{\ntables}}
\providecommand{\algAtables}{\StrLeft{ABC}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        than 1, with Bonferroni correction by the number of functions (24). A $\downarrow$ indicates the same tested against the best algorithm from BBOB 2009. Best results are printed in bold.
        \cocoversion}
\providecommand{\algsfolder}{ABC_CMA-E_DE_DEPSO_PSO/}
\providecommand{\algorithmA}{ABC}
\providecommand{\algorithmB}{CMA-ES}
\providecommand{\algorithmC}{DE}
\providecommand{\algorithmD}{DEPSO}
